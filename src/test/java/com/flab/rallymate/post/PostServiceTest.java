...
class PostServiceTest {
    ...
    void addPost_메이트_구인글_등록요청시_등록에_성공한다() throws Exception {
        ...
        var findPlayground = PlaygroundEntity.builder().id(postRequestDTO.playgroundId()).name("송실내테니스").build();
    ...
    @Test
    void addPost_구인_글_작성_요청시_조회된_플레이장소가_없다면_NOT_FOUND_PLAYGROUND_예외가_발생한다() {
