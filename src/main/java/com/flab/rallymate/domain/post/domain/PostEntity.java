...
public class PostEntity extends BaseEntity {
    ...
    public void changePlayground(PlaygroundEntity playground) {
        this.playground = playground;
    }

    @Builder
    public PostEntity(int playTime, LocalDateTime startTime, MemberEntity member, PlaygroundEntity playground) {
